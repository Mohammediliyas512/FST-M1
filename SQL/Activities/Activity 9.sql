...
select a.customer_name as "Customer Name", a.city, b.name as "Salesman", b.comission  
...
select a.customer_name, a.city, a.grade, b.salesman_name, b.city from customers a left outer join salesman b  
on a.salesman_id=b.salesman_id where a.grade<300 order by a.customer_id;

select a.customer_name, a.city, a.grade, b.salesman_name, b.salesman_city from customers a left outer join salesman b  
on a.salesman_id=b.salesman_id where a.grade<300 order by a.customer_id;

select a.customer_name as "Customer name", a.city, b.salesman_name as "salesman", b.commission from  
...
c.commission from orders a inner join customer b on a.customer_id=b.customer_id  
